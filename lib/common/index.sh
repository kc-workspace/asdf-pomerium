...
KC_ASDF_NAME="asdf-pomerium"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-pomerium"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="pomerium-cli"
KC_ASDF_APP_WEBS="https://www.pomerium.com"
KC_ASDF_APP_DESC="it's used to generate encrypted and authenticated connections for services that are not accessed through a web browser"
KC_ASDF_APP_CMDS="
- test    - test if cli exist and executable
- version - print *plugin* version
"
KC_ASDF_APP_REPO="https://github.com/pomerium/cli"
